...
public class AIEnemigaEvilJavaly : MonoBehaviour
{
   public Animator anim;
    ...
    void Update()
    {
      ...
      {
          PerseguirJugador(); //funcion para seguir al jugador
    ...
    {
        //si el enemigo esta a la izquierda del jugador entonces se mueve a la derecha
